                ...
                <div className="mask">
                    ...
                    <div className="title1"> 江湖风云 </div>
                        <div className="rotation">
                            ...
                            <img src={pic3} className="image"></img>

                            <input type="radio" name="rotation" className="rota_input"></input>
                            <img src={pic4} className="image"></img>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        ...
                        <div className="btn">
                          <Link to={'/join'} className="link"> <div className="next">NEXT</div> </Link> 
                          <Link to={'/travel'} className="link"><div className="previous">PREVIOUS</div></Link>
                        </div>
                    </div>
                    <div>
